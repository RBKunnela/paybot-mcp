...
# ─────────────────────────────────────────────────────────────────────────────
# COMMAND CATEGORIES (for dynamic guide generation)
# ─────────────────────────────────────────────────────────────────────────────
command_categories:
  CRIACAO:
    display: 'CRIAÇÃO'
...
self_awareness:
  ...
  # ─────────────────────────────────────────────────────────────────────────────
  # GUIDE CONTENT (*guide command) - GENERATED DYNAMICALLY
  # ─────────────────────────────────────────────────────────────────────────────

  guide_content:
    generator: 'node squads/squad-creator/scripts/generate-squad-guide.js squad-creator'
    fallback: 'Type *help to see available commands'
    note: 'Guide is generated dynamically from agent files. Update this field only if changing generator script location.'
```
