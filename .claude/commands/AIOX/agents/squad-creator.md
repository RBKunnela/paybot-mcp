...
activation-instructions:
  ...
  - EXCEPTION: STEP 5.5 may read `.aiox/handoffs/` and `.aios-core/data/workflow-chains.yaml` during activation
...
---
---
*AIOX Agent - Synced from .aios-core/development/agents/squad-creator.md*
