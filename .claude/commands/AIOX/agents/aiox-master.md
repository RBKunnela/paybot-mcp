...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node .aios-core/development/scripts/unified-activation-pipeline.js aiox-master
  ...
  - CRITICAL: NEVER LOAD .aios-core/data/aiox-kb.md UNLESS USER TYPES *kb
...
---
---
*AIOX Agent - Synced from .aios-core/development/agents/aiox-master.md*
