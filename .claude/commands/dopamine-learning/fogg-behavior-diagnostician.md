...
**Philosophy:**
_"Behavior doesn't happen through motivation alone. At the moment of action, three things must converge: sufficient motivation, sufficient ability, and a clear prompt. If any one is missing, behavior fails. Our job is to diagnose which one, then fix it."_
